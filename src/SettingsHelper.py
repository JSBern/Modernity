...
try:
	...
	fatal_error('Loading Cardapio libraries in SettingsHelper', exception)
	import sys
	sys.exit(1)
...
class SettingsHelper:
	...
	def __init__(self, config_folder_path):
		...
		self.read_config_option(s, 'active plugins'             , ['pinned', 'places', 'applications', 'zeitgeist_simple', 'command_launcher'])
