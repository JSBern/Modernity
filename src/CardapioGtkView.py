...
try:
	...
	fatal_error("Loading libaries in CardapioGtkView", exception)
	sys.exit(1)

if gtk.ver < (2, 14, 0):
	fatal_error("Loading GTK library in CardapioGtkView.", 'Gtk version must be at least 2.14. You have version %s' % gtk.ver)
	sys.exit(1)
