...
install-panel: install-alone
	...
	mkdir -p $(PREFIX)/share/gnome-panel/5.0/applets
	cp -f src/gnomepanel/cardapio.panel-applet $(PREFIX)/share/gnome-panel/5.0/applets/org.gnome.applets.CardapioGnomeApplet.panel-applet
